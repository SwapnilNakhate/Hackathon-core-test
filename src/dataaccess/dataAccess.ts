...
class DataAccess {
    ...
    public static connect(): Mongoose.Connection {
        ...
        if(process.env.pathToMongoDb != null) {
            ...
            // dbURL = "mongodb://amaresh15:Ami1982#@qadbcluster-shard-00-00-1hsyg.azure.mongodb.net:27017,qadbcluster-shard-00-01-1hsyg.azure.mongodb.net:27017,qadbcluster-shard-00-02-1hsyg.azure.mongodb.net:27017/test?ssl=true&replicaSet=QADBcluster-shard-0&authSource=admin&retryWrites=true&w=majority";
        }
